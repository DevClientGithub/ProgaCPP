...
/* Я блять всё понимаю, но это походу нихуя не Sha256
  А если и она то блять, она какая-то корявая нахуй
  Я вообще не ебу какого хуя оно выдаёт одно, но на сайте с Sha256 кодировщиком совсем другое
  Либо это новый вид кодирования конченный, либо оно просто идёт нахуй
  Я думаю что второе
  Но оно вроде хотяб даёт одинаковое значение для слова
  Крч похуй, позже углубимся по фуллу
  Но я думаю, нам это не нужно будет, так как у нас прога на 2 чубздрика без серверов будет
  Ну или мы всё таки сделаем сервера и систему акков
  Хуй знает крч, позже будем разбираться*/
